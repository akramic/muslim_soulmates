defmodule MuslimSoulmatesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MuslimSoulmatesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MuslimSoulmatesWeb.Gettext, "errors", msg, opts)
    end
  end
